  ...
  return (
    ...
    >
      <span className="flex items-center space-x-2">
        <span className="flex justify-center items-center h-5 w-5 shrink-0 border border-neutral-200 bg-neutral-100 rounded-full text-neutral-950 ring-offset-neutral-50 cursor-pointer group-hover:bg-neutral-200 group-data-[focus-visible=true]:outline-none group-data-[focus-visible=true]:ring-2 group-data-[focus-visible=true]:ring-brand-500 group-data-[focus-visible=true]:ring-offset-2 group-data-[disabled=true]:cursor-not-allowed group-data-[selected=true]:bg-brand-500 group-data-[selected=true]:text-brand-50 group-data-[selected=true]:border-brand-500 dark:bg-neutral-800 dark:border-neutral-700 dark:ring-offset-neutral-950 dark:group-hover:bg-neutral-700 dark:group-data-[selected=true]:bg-brand-500 dark:group-data-[selected=true]:text-brand-50 dark:group-data-[selected=true]:border-brand-500">
